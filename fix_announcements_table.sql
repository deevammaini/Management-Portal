-- Fix announcements table to match data structure
-- Run this in Supabase SQL Editor

-- Drop and recreate announcements table with correct structure
...
-- Now run the announcements data from supabase_data_import.sql
